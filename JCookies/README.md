...
Alguns exemplos: 
	...
	//Forma Personalizada de criar uma cookie (String value, String comment, String domain, Integer time, Integer version,  String nameCookie) 	
	cookie.createCookiesCustom("valorASerGuardado", "Cookie de login", "/localhost:8080", Integer 10000, "1","nomeDaCookie")
